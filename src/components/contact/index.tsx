...
const Contact = () => {
  return (
    <section className="flex flex-col items-center justify-center relative bg-[#F1CE96] rounded-t-[50px] px-5 md:px-10 lg:px-40 2xl:px-80 pt-5 md:pt-10 lg:pt-20 pb-32">
