...
const Projects = () => {
  ...
  return (
    <section
      className="flex flex-col md:flex-row md:gap-10 relative top-[50px] bg-[#FFDBA1] rounded-t-[50px] px-5 md:px-10 lg:px-40 2xl:px-80 pt-5 md:pt-10 lg:pt-20 pb-20 md:pb-28"
    >
