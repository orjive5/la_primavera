const About = () => {
  ...
  return (
    <section
      className="flex flex-col md:flex-row relative top-[100px] gap-10 bg-[#FFE9C6] px-5 md:px-10 lg:px-40 2xl:px-80 pt-5 md:pt-10 lg:pt-20 pb-20 md:pb-28 rounded-t-[50px]"
    >
