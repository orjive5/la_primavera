...
const Footer = () => {
  return (
    <section id="footer" className="z-10 flex items-center relative justify-center bg-[#E6C999] top-[-50px] min-h-[300px] w-full rounded-t-[50px] px-5 md:px-10 lg:px-20 py-10 lg:py-40">
      ...
      <div className="bg-[#E6C999] absolute bottom-[-56px] h-32 w-full z-0"></div>
    </section>
  );
};
